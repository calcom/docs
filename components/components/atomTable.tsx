import { bookerAtomPropsData, availabilitySettingsAtomPropsData, googleCalendarAtomPropsData, outlookCalendarAtomPropsData, appleCalendarAtomPropsData } from "@utils/atomsPropTableData";
