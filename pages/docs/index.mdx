...
<div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12">
  ...
  <div className="col-span-2">
    <img className="border border-neutral-100 rounded-md overflow-hidden" src="https://res.cloudinary.com/djp21wtxm/image/upload/v1663614673/i1436x808-0nKukNzRRdrO_pyvmqa.png" />
  </div>
</div>
